# -*- coding: utf-8 -*-
"""
Created on Fri Nov 04 19:40:10 2016
...
8
voters
by MrBoo · last run 6 days ago · Python script · 938 views
using data from Bosch Production Line Performance · 
 Public
Code
Output (8)
Comments (1)
...
Forks (5)
Fork Script
You are viewing the last successful run of this script. Click here to see the current version with an error.
Code
...
def Train32_33_34() :
    ...
    del train_date_part, train_start_date, test_start_date, date_cols
    gc.collect()
    start_date.head()
    ...
    del train_test_id, train_id, test_id
...
def Test32_33_34() :
    ...
    del train_date_part, train_start_date, date_cols
...
def GrabData():
    ...
    del df_mindate
    train_temp = Train32_33_34()
    test_temp = Test32_33_34()
    traindata = traindata.merge(train_temp, on='Id')
    testdata = testdata.merge(test_temp, on='Id')
